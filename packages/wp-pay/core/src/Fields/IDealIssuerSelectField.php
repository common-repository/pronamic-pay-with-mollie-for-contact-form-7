...
class IDealIssuerSelectField extends SelectField {
	...
	protected function setup() {
		...
		$this->set_label( \__( 'Bank', 'pronamic-pay-with-mollie-for-contact-form-7' ) );
	}
	...
	public function get_options() {
		...
		return [
			 ...
			 */
			new SelectFieldOption( '', __( '— Choose your bank —', 'pronamic-pay-with-mollie-for-contact-form-7' ) ),
