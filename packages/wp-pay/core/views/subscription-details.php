...
$details = [
	[
		'term'        => __( 'Description', 'pronamic-pay-with-mollie-for-contact-form-7' ),
...
if ( null !== $phase ) {
	// Amount.
	$details[] = [
		'term'        => __( 'Amount', 'pronamic-pay-with-mollie-for-contact-form-7' ),
...
if ( ! empty( $payment_method ) ) {
	$details[] = [
		'term'        => __( 'Payment method', 'pronamic-pay-with-mollie-for-contact-form-7' ),
...
// Recurrence.
$details[] = [
	'term'        => __( 'Recurrence', 'pronamic-pay-with-mollie-for-contact-form-7' ),
	'description' => $recurrence,
];

?>

<h2><?php esc_html_e( 'Subscription', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?></h2>
