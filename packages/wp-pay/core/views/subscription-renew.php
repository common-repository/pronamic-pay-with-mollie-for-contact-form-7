				...
				<div class="pp-page-section-container">
					<div class="pp-page-section-wrapper alignleft">
						...
						<?php if ( null === $next_period ) : ?>
							...
							<p>
								<?php echo esc_html__( 'This subscription can not be renewed.', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>
							</p>
						...
						<?php else : ?>
							...
							<p>
								...
								printf(
									...
									esc_html( __( 'Renew the subscription by paying for the period %s.', 'pronamic-pay-with-mollie-for-contact-form-7' ) ),
									esc_html( $next_period->human_readable_range( __( 'l j F Y', 'pronamic-pay-with-mollie-for-contact-form-7' ), _x( 'until', 'period separator', 'pronamic-pay-with-mollie-for-contact-form-7' ) ) )
								);
