...
<table class="form-table">
	<tr>
		...
		<td>
			<?php the_time( __( 'l jS \o\f F Y, h:ia', 'pronamic-pay-with-mollie-for-contact-form-7' ) ); ?>
		</td>
	</tr>
	<tr>
		<th scope="row">
	...
	<tr>
		<th scope="row">
			<?php echo esc_html__( 'Recurrence', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>
		</th>
		<td>
			<?php
	...
	if ( SubscriptionStatus::ACTIVE === $subscription->get_status() ) :
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Next Payment Date', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>
			</th>
			<td>
				<?php
				...
				echo empty( $next_payment_date ) ? '—' : esc_html( $next_payment_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-contact-form-7' ) ) );
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Next Payment Delivery Date', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>
			</th>
			<td>
				<?php
				...
				echo empty( $next_payment_delivery_date ) ? '—' : esc_html( $next_payment_delivery_date->format_i18n( __( 'D j M Y', 'pronamic-pay-with-mollie-for-contact-form-7' ) ) );
	...
	<tr>
		<th scope="row" rowspan="3">
			<?php esc_html_e( 'Customer action links', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>

			<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php echo esc_attr__( 'These actions links can be shared with the customer.', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>" tabindex="0"></span>
			...
			<div class="pronamic-pay-action-link">
				<div>
					...
					\printf(
						...
						\esc_attr( $url ),
						\esc_html__( 'Customer subscription cancel page →', 'pronamic-pay-with-mollie-for-contact-form-7' )
					);
				...
				<div>
					<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php echo \esc_attr__( 'This page can be shared with the customer and gives the customer the option to cancel this subscription.', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>" tabindex="0"></span>
				</div>

				<div class="pronamic-pay-action-link-clipboard">
					<button type="button" class="button button-small pronamic-pay-copy-url" data-clipboard-text="<?php echo \esc_url( $url ); ?>"><?php \esc_html_e( 'Copy URL to clipboard', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?></button>
					<span class="success hidden" aria-hidden="true"><?php \esc_html_e( 'Copied!', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?></span>
				</div>
			</div>
		</td>
	</tr>
			...
			<div class="pronamic-pay-action-link">
				<div>
					...
					\printf(
						'<a class="pronamic-pay-action-link-anchor" href="%s">%s</a>',
						\esc_attr( $url ),
						\esc_html__( 'Customer subscription renew page →', 'pronamic-pay-with-mollie-for-contact-form-7' )
					);
				...
				<div>
					<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php echo \esc_attr__( 'This page can be shared with the customer and gives the customer the option to (early) renew the subscription.', 'pronamic-pay-with-mollie-for-contact-form-7' ); ?>" tabindex="0"></span>
				</div>
			...
			<div class="pronamic-pay-action-link">
				<div>
					...
					\printf(
						'<a class="pronamic-pay-action-link-anchor" href="%s">%s</a>',
						\esc_attr( $url ),
						\esc_html__( 'Customer change payment method page →', 'pronamic-pay-with-mollie-for-contact-form-7' )
					);
