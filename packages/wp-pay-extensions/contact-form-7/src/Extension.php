...
class Extension extends AbstractPluginIntegration {
	...
	public function __construct() {
		parent::__construct(
			[
				'name'    => __( 'Contact Form 7', 'pronamic-pay-with-mollie-for-contact-form-7' ),
				'version' => '1.0.0',
			]
		);
		...
		if ( \array_key_exists( 'pronamic_pay_redirect_url', $result ) ) {
			$result = \array_merge(
				...
				[
					...
					'message' => \__( 'Please wait while redirecting for payment', 'pronamic-pay-with-mollie-for-contact-form-7' ),
				]
			);
		}
	...
	public function source_text( $text, Payment $payment ) {
		return __( 'Contact Form 7', 'pronamic-pay-with-mollie-for-contact-form-7' );
	}
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'Contact Form 7 Entry', 'pronamic-pay-with-mollie-for-contact-form-7' );
	}
}
