		...
		return \array_merge(
			...
			[
				'invalid_pronamic_pay_amount' => [
					'description' => __( 'Input amount is invalid.', 'pronamic-pay-with-mollie-for-contact-form-7' ),
					'default'     => __( 'The input amount is invalid.', 'pronamic-pay-with-mollie-for-contact-form-7' ),
				],
			]
		);
	}
