...
class PaymentMethodTag {
		...
		return \array_merge(
			...
			[
				'invalid_pronamic_pay_method_required' => [
					'description' => __( 'Payment method required.', 'pronamic-pay-with-mollie-for-contact-form-7' ),
					'default'     => __( 'The payment method is invalid.', 'pronamic-pay-with-mollie-for-contact-form-7' ),
				],
			]
		);
	}
	...
	public function add_tag_generator() {
		...
		$tag_generator->add( self::TAG, \__( 'payment method', 'pronamic-pay-with-mollie-for-contact-form-7' ), [ $this, 'tag_generator' ] );
	}
