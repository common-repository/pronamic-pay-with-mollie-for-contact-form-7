...
class Admin {
	...
	public function admin_menu() {
		...
		add_menu_page(
			__( 'Mollie', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			__( 'Mollie', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			'manage_options',
			'pronamic_pay_mollie',
			[ $this, 'page_mollie' ],
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Profiles', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			__( 'Profiles', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Customers', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			__( 'Customers', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Mandates', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			__( 'Mandates', 'pronamic-pay-with-mollie-for-contact-form-7' ),
			'manage_options',
		...
		add_submenu_page(
			'pronamic_pay_mollie',
			__( 'Mollie Payments', 'pronamic-pay-with-mollie-for-contact-form-7' ),
